...
\begin{itemize}
	...
	\item The algorithm presented can plan a path which not only minimizes distance travelled, but also account for robotic manipulator dynamics such as acceleration and jerk.
